...
<head>
    ...
    <style>
        body {
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.5)), url('mortalcombat.jpg');
        }
    </style>
</head>
...
<body>
    ...
    <div>
        <video class="trailer" src="Mortal Kombat (2021) - Official Red Band Trailer.mp4" width="800" height="500"
