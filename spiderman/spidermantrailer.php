...
<head>
    ...
    <style>
        body {
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.5)), url('spiderman.jpg');
        }
    </style>
</head>
...
<body>
    ...
    <div>
        <video class="trailer" src="Spider-Man_ Homecoming - Official Trailer 2 [HD].mp4" width="800" height="500"
