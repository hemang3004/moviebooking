...
<head>
    ...
    <style>
        body {
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.5)), url('suicide squad.jpg');
        }
    </style>
</head>
...
<body>
    ...
    <div>
        <video class="trailer" src="THE SUICIDE SQUAD Trailer (2021) Suicide Squad 2 Movie.mp4" width="800" height="500"
