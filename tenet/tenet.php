...
<head>
    ...
    <style>
        body{
    background: linear-gradient(rgba(0, 0, 0, 0.973),rgba(0,0,0,0.5)),url('tenet.jpg');
}
    </style>
</head>
    ...
    <div>
        <section id="content">
            <div class="container">
                <div class="img1">
                    <div class="boxX">
                        <img src="tenet.jpg" class="image" alt="" height="700" width="700">
                        <div class="fit">
                            <a href="tenettrailer.php"><i class="fas fa-play" ></i></a>
                        </div>
                    </div>
                    <div class="boxY">
                        <p><strong>
                                Avaliable Languages:English,Telugu,Tamil,Hindi <br><br>
                                Total time:2h 31m<br><br>
                                Genre: Action,Thriller,Sci-Fi. <br><br> Release Date:4 DEC, 2020.
                            </strong> </p>
                    </div>
                </div>
                <div class="info">
                    ...
                    <div class="movieinfo">
                        ...
                        <strong><a href="https://www.imdb.com/title/tt6723592/" target="_self">...for More</a></strong>
                    </div>
